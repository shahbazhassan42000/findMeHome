        ...
        <div>
            <div className="flex flex-col w-[60%] mx-auto items-center">
                ...
                <div className="font-['Montserrat'] flex space-x-10">
                    <div className="w-[400px] flex flex-col space-y-4 items-start p-[35px] bg-white shadow-[4px_5px_6px_1px_#CFCFD0] rounded-[4px]">
                        ...
                        <a href="/signup/a" className="bg-[#3E665C] hover:bg-[#5A8081] py-[5px] px-[50px] mx-auto text-white rounded-[14px]">
                            Sign up
                        </a>
                    </div>
                    <div className="w-[400px] flex flex-col space-y-4 items-start p-[35px] bg-white shadow-[4px_5px_6px_1px_#CFCFD0] rounded-[4px]">

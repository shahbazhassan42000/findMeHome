                                ...
                                <div className={"flex w-[100%]"}>
                                    <div className={"flex flex-col w-[100%]"}>
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Firstname</label><br/>
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Username</label><br/>
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Contact</label><br/>
                                    ...
                                    <div className={"flex flex-col ml-10 w-[100%]"}>
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Lastname</label><br/>
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Address</label><br/>

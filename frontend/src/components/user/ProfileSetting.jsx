                            ...
                            <form onSubmit={submitHandle} className={"form max-w-[800px] w-[100%]"}>
                                <div className={"flex w-[100%]"}>
                                    <div className={"flex flex-col w-[100%]"}>
                                        {user.type === "shelter" ?
                                            <div className={"h-[90px] mb-5"}>
                                                <label
                                                    className={"text-[16px] text-[#3E665C] font-bold"}>Name</label><br/>
                                                <input
                                                    className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                            ...
                                            <div className={"h-[90px] mb-5"}>
                                                <label
                                                    className={"text-[16px] text-[#3E665C] font-bold"}>Firstname</label><br/>
                                                <input
                                                    className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label
                                                className={"text-[16px] text-[#3E665C] font-bold"}>Username</label><br/>
                                            <input
                                                className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                        ...
                                        <div className="h-[90px] mb-5">
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Country</label>
                                            <br/>
                                            <CountryDropdown
                                                required
                                                name="country"
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>City</label><br/>
                                            <select
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label
                                                className={"text-[16px] text-[#3E665C] font-bold"}>Contact</label><br/>
                                            <input
                                                className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                    ...
                                    <div className={"flex flex-col ml-10 w-[100%]"}>
                                        {user.type === "adopter" && <div className={"h-[90px] mb-5"}>
                                            <label
                                                className={"text-[16px] text-[#3E665C] font-bold"}>Lastname</label><br/>
                                            <input
                                                className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>Email</label><br/>
                                            <input
                                                className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                                type={"text"} value={email} onChange={(e) => setEmail(e.target.value)}/>
                                        </div>
                                        <div className={"h-[90px] mb-5"}>
                                            <label className={"text-[16px] text-[#3E665C] font-bold"}>State</label><br/>
                                            <select
                                        ...
                                        <div className={"h-[90px] mb-5"}>
                                            <label
                                                className={"text-[16px] text-[#3E665C] font-bold"}>Address</label><br/>
                                            <input
                                                className={"bg-transparent border-b border-[#3E665C] w-[100%] text-[#7F99A2] h-[50px] p-2 outline-0 focus:border-[#70CF36]"}
                                        ...
                                        <button
                                            className={"rounded-[21px] mt-8 text-white text-[13px] font-[600] bg-[#3E665C] w-full h-[40px]"}
                                            type={"submit"}>Update
                                        </button>
                                    </div>
                                </div>
